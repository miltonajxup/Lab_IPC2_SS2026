 ...
 * @author milton
 */
public class ArchivoReporteGananciasGenerales {
    
    private String carpeta = "Reporte";
    private final String NOMBRE = "reporteGanancias.html";
    private int contador;
    
    private final ReporteAdministradorDAO reportedao;

    public ArchivoReporteGananciasGenerales() {
    ...
    public String getReporte(String ruta, String fechaInicial, String fechaFinal, boolean totales) throws AccesoALaDataException {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(file))) {
            writer.println(armarRerporte(fechaInicial, fechaFinal, totales));
        } catch (IOException e) {
    ...
    public String armarRerporte(String fechaInicial, String fechaFinal, boolean totales) throws AccesoALaDataException {
        ...
        if (totales) {
            ...
            ReporteGanancia rep = reportedao.getTotalGanancia(dateInicial, dateFinal);
            reporte += ("<td >" + rep.getVentas()+ "</td>"); 
            ...
            reporte += ("<td >" + rep.getTotalGanancias()+ "</td>"); 
            reporte += "</tr>";
        } else {
