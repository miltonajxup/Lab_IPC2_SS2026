...
public class HorarioDAO {
    ...
    public void agregarHorario(HorarioRequest request) throws AccesoALaDataException {
        ...
        try {
            ...
            insert.setString(1, request.getHoraSalida());
            insert.setString(2, request.getHoraLlegada());
            insert.setInt(3, request.getRuta());
    ...
    public boolean existeHorario(HorarioRequest request) throws AccesoALaDataException {
        ...
        try {
            ...
            select.setString(1, request.getHoraSalida());
            select.setString(2, request.getHoraLlegada());
            select.setInt(3, request.getRuta());
    ...
    public List<HorarioDB> getHorariosRuta(int ruta) throws AccesoALaDataException {
    ...
    private HorarioDB armarHorario(ResultSet rs) throws SQLException {
        return new HorarioDB(
                ...
                rs.getString("horario_aprox_llegada"), 
                rs.getInt("ruta"));
    }
