...
<html>
    ...
    <body>
        ...
        <a class="boton" href="${pageContext.servletContext.contextPath}/index.jsp">Cerrar Sesion</a> <br> <br>
        ...
        Opciones Para Administradores de Sucursal
        <div class="menuBotones">
        ...
        <div class="menuBotones">
            ...
            <a class="boton" 
               href="${pageContext.servletContext.contextPath}/mvc/administrador/reporte/reporte-servlet?reporte-choferes=reporteChoferes&sucursal=${usuarioLogeado.sucursal}">
                Reporte de Choferes
            </a>
            <a class="boton" 
               href="${pageContext.servletContext.contextPath}/mvc/administrador/reporte/reporte-boletos.jsp">
                Reporte de Boletos
            </a>
            <a class="boton" 
               href="${pageContext.servletContext.contextPath}/mvc/administrador/reporte/reporte-servlet?reporte-depreciacion=reporteDepreciacion&sucursal=${usuarioLogeado.sucursal}">
